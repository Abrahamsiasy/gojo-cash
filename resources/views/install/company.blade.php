...
<head>
    ...
    <title>Install - Create Company</title>
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h1 class="text-2xl font-bold mb-6 text-center">Installation - Step 4</h1>
        <h2 class="text-xl mb-4 text-center">Create Company</h2>
        <p class="text-sm text-gray-600 mb-4 text-center">Create your first company to get started.</p>
        ...
        <form action="{{ route('install.step4.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('install.step3') }}" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline text-center">
                    ← Back to Step 3
                </a>
