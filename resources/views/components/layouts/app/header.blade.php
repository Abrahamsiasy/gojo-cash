...
<header class="bg-white dark:bg-gray-800 shadow-sm z-20 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-4 font-semibold text-xl text-blue-600 dark:text-blue-400 sidebar-accent-foreground" style="color: oklch(27.8% .033 256.848) !important">{{ config('app.name') }}</div>
        </div>
